...
local function check_member_super(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = 'این سوپر گروه با موفقیت به لیست گروه های مدیریتی ربات تله بلاستراضافه شد'
...
local function check_member_superrem(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = 'این سوپر گروه با موفقیت از لیست گروه های مدیریتی تله بلاستر حذف شد'
      return reply_msg(msg.id, text, ok_cb, false)
    end
  end
end
...
local title ="اطلاعات این سوپرگروه: ["..result.title.."]\n\n"
local admin_num = "تعدادادمین ها: "..result.admins_count.."\n"
...
--vardump(result)
local text = "این کاربر به دلیل رعایت نکردن قوانین اخراج شد"..cb_extra.receiver.."\n\n"
local i = 1
for k,v in pairsByKeys(result) do
if not v.print_name then
	name = " "
...
local function lock_group_links(msg, data, target)
  ...
  if group_link_lock == 'yes' then
    local text = 'ارسال لینک ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_link'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'ارسال لینک با موفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_links(msg, data, target)
  ...
  if group_link_lock == 'no' then
    local text = 'ارسال لینک ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_link'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'ارسال لینک با موفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_inline(msg, data, target)
  ...
  if group_inline_lock == 'yes' then
    local text = 'ارسال مطلب اینلاین ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_inline'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'ارسال مطلب اینلاین با موفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_inline(msg, data, target)
  ...
  if group_inline_lock == 'no' then
    local text = 'ارسال مطلب اینلاین ازقبل دراین سوپرگروه آزادبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_inline'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'ارسال مطلب اینلاین با موفقیت دراین سوپر گروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_operator(msg, data, target)
  ...
  if group_operator_lock == 'yes' then
    local text = 'ارسال تبلیغات اوپراتورها دراین سوپرگروه ازقبل قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_operator'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'ارسال تبلیغات اوپراتورها با موفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_operator(msg, data, target)
  ...
  if group_operator_lock == 'no' then
    local text = 'ارسال تبلیغات اوپراتورها ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_operator'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'ارسال تبلیغات او پراتورها باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_reply(msg, data, target)
  ...
  if group_reply_lock == 'yes' then
    local text = 'ارسال مطلب باریپلی ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_reply'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'ارسال مطلب باریپلی با موفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_reply(msg, data, target)
  ...
  if group_reply_lock == 'no' then
    local text = 'ارسال مطلب باریپلی ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_reply'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'ارسال مطلب باریپلی باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_join(msg, data, target)
  ...
  if group_join_lock == 'yes' then
    local text = 'عضوشدن ازقبل دراین سوپرگروه قفل بوده است '
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_join'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'عضوشدن باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_join(msg, data, target)
  ...
  if group_join_lock == 'no' then
    local text = 'عضوشدن ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_join'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'عضوشدن با موفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_fwd(msg, data, target)
  ...
  if group_fwd_lock == 'yes' then
    local text = 'ارسال مطلب فرواردشده ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_fwd'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'ارسال مطلب فرواردشده باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_fwd(msg, data, target)
  ...
  if group_fwd_lock == 'no' then
    local text = 'ارسال مطلب فرواردشده ازقبل دراین سوپرگروه آزادبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_fwd'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'ارسال مطلب فروارد شده باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_all(msg, data, target)
  ...
  if group_all_lock == 'yes' then
    local text = 'قفل همه ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    ...
    save_data(_config.moderation.data, data)
    local text = 'قفل همه باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_all(msg, data, target)
  ...
  if group_all_lock == 'no' then
    local text = 'قفل همه ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    ...
    save_data(_config.moderation.data, data)
    local text = 'قفل همه باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_number(msg, data, target)
  ...
  if group_number_lock == 'yes' then
    local text = 'ارسال شماره ازقبل دراین سوپرگروه فل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_number'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'ارسال شماره باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_number(msg, data, target)
  ...
  if group_number_lock == 'no' then
    local text = 'ارسال شماره ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_number'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'ارسال شماره باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_english(msg, data, target)
  ...
  if group_english_lock == 'yes' then
    local text = 'صحبت کردن با زبان انگلیسی ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_english'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'صحبت کردن با زبان انگلیسی باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_english(msg, data, target)
  ...
  if group_english_lock == 'no' then
    local text = 'صحبت کردن با زبان انگلیسی ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_english'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'صحبت کردن با زبان انگلیسی باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_leave(msg, data, target)
  ...
  if group_leave_lock == 'yes' then
    local text = 'قفل خروج ازقبل دراین سوپرگروه فعال بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_leave'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'قفل خروج با موفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_leave(msg, data, target)
  ...
  if group_leave_lock == 'no' then
    local text = 'قفل خروج ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_leave'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'قفل خروج باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_tags(msg, data, target)
  ...
  if group_tag_lock == 'yes' then
    local text = 'ارسال تگ ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_tags'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'ارسال تگ باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_tags(msg, data, target)
  ...
  if group_tag_lock == 'no' then
    local text = 'ارسال تگ ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_tags'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'ارسال تگ باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == 'yes' then
    local text = 'ارسال ایموجی ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_emoji'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'ارسال ایموجی باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == 'no' then
    local text = 'ارسال ایموجی ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_emoji'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'ارسال ایموجی باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_username(msg, data, target)
  ...
  if group_username_lock == 'yes' then
    local text = 'ارسال یوزرنیم ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_username'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'ارسال یوزرنیم باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_username(msg, data, target)
  ...
  if group_username_lock == 'no' then
    local text = 'ارسال یوزرنیم ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_username'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'ارسال یوزرنیم باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_media(msg, data, target)
  ...
  if group_media_lock == 'yes' then
    local text = 'ارسال رسانه ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_media'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'ارسال رسانه باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_media(msg, data, target)
  ...
  if group_media_lock == 'no' then
    local text = 'ارسال رسانه از قبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_media'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'ارسال رسانه باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_bots(msg, data, target)
  ...
  if group_bots_lock == 'yes' then
    local text = 'اضافه کردن ربات ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_bots'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'اضافه کردن ربات باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_bots(msg, data, target)
  ...
  if group_bots_lock == 'no' then
    local text = 'اضافه کردن ربات ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_bots'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'اضافه کردن ربات باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_spam(msg, data, target)
  ...
  if not is_owner(msg) then
    return "شما صاحب اصلی گروه نیستید"
  end
  local group_spam_lock = data[tostring(target)]['settings']['lock_spam']
  if group_spam_lock == 'yes' then
    local text = 'ارسال مطلب به صورت اسپم ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_spam'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'ارسال مطلب به صورت اسپم باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'no' then
    local text = 'ارسال مطلب به صورت اسپم ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_spam'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'ارسال مطلب به صورت اسپم باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'yes' then
    local text = 'فلود ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['flood'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'فلود باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'no' then
    local text = 'فلودازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['flood'] = 'no'
    save_data(_config.moderation.data, data)
...
local function lock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'yes' then
    local text = 'صحبت کردن بازبان عربی ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_arabic'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'صحبت کردن بازبان عربی باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'no' then
    local text = 'صحبت کردن بازبان عربی ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_arabic'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'صحبت کردن بازبان عربی باموفقیت دراین سوپرگروه آزاد شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'yes' then
    local text = 'اعضای گروه ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_member'] = 'yes'
    save_data(_config.moderation.data, data)
  end
  local text = 'اعضای گروه باموفقیت دراین سوپرگروه قفل شد'
  return reply_msg(msg.id, text, ok_cb, false)
end
...
local function unlock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'no' then
    local text = 'اعضای گروه ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_member'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'اعضای گروه باموفقیت دراین گروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'yes' then
    local text = 'راستچین ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_rtl'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'راستچین باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'no' then
    local text = 'راستچین ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_rtl'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'راستچین باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_tgservice(msg, data, target)
  ...
  if group_tgservice_lock == 'yes' then
    local text = 'خدمات ورودوخروج ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_tgservice'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'خدمات ورودوخروج باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_tgservice(msg, data, target)
  ...
  if group_tgservice_lock == 'no' then
    local text = 'خدمات ورودوخروج ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_tgservice'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'خدمات ورودوخروج باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'yes' then
    local text = 'ارسال استیکر ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_sticker'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'ارسال استیکر باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'no' then
    local text = 'ارسال استیکر ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_sticker'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'ارسال استیکر باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function lock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'yes' then
    local text = 'اشتراک گزاری شماره ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_contacts'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'اشتراک گزاری شماره باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function unlock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'no' then
    local text = 'اشتراک گزاری شماره ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['lock_contacts'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'اشتراک گزاری شماره باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function enable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'yes' then
    local text = 'تنظیمات سختگیرانه ازقبل دراین سوپرگروه قفل بوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['strict'] = 'yes'
    save_data(_config.moderation.data, data)
    local text = 'تنظیمات سختگیرانه باموفقیت دراین سوپرگروه قفل شد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function disable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'no' then
    local text = 'تنظیمات سختگیرانه ازقبل دراین سوپرگروه قفل نبوده است'
	return reply_msg(msg.id, text, ok_cb, false)
  else
    data[tostring(target)]['settings']['strict'] = 'no'
    save_data(_config.moderation.data, data)
    local text = 'تنظیمات سختگیرانه باموفقیت دراین سوپرگروه آزادشد'
	return reply_msg(msg.id, text, ok_cb, false)
  end
end
...
local function set_rulesmod(msg, data, target)
  ...
  save_data(_config.moderation.data, data)
  local text = 'قوانین با موفقیت دراین سوپر گروه تنظیم شد'
end
	...
	local data = load_data(_config.moderation.data)
		...
		if matches[1] == 'id' then
			...
			elseif msg.text:match("@[%a%d]") then
				...
				local userlink = ""
				if msg.from.username then
					userlink = "🔷YourLink : http://telegram.me/"..msg.from.username
				end
