...
define('BOT_TOKEN', '284008451:AAGOxFevvdkCW6NX745hAkEKtz1FlBxH9go');
...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=https://pvs1-resanmmm.rhcloud.com/'.$chat_id.'/pvresan.php');
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=https://pvs1-resanmmm.rhcloud.com/'.$chat_id.'/pvresan.php');
...
";
    ...
    $bot_url    = "https://api.telegram.org/bot284008451:AAGOxFevvdkCW6NX745hAkEKtz1FlBxH9go/"; 
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[0].'/setwebhook?url=https://pvs1-resanmmm.rhcloud.com/'.$id.'/pvresan.php');
    $unstalled = "🔰 ربات شما با موفقیت نصب شد 🔰 
 برای ورود به ربات خود کلیک کنید 
 به ربات ما امتیاز دهید 
 https://telegram.me/storebot?start=PayamResanSazRoBot
